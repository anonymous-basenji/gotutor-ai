...
export const meta: MetaFunction = () => [
  { title: "Terms of Service — GoTutor.ai" },
  { name: "description", content: "Read the GoTutor.ai terms of service, covering account types, supervisor responsibilities, AI disclaimers, and governing law." },
];
